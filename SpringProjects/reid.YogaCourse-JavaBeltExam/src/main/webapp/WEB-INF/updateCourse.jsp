...
<body>
	<div class="container mt-5">
		...
		<form:form action="/courses/${course.id}/edit" method="post" modelAttribute="course" class="mb-4">
			...
			<div class="form-group text-right">
			    <a href="/courses/${course.id}/delete" class="btn btn-danger mr-auto float-left">Delete Course</a>
